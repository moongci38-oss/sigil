...
| `s4-sitemap.md` | `{folderMap.product}/{project}/YYYY-MM-DD-s4-sitemap.md` |
| `s4-roadmap.md` | `{folderMap.product}/{project}/YYYY-MM-DD-s4-roadmap.md` |
| `s4-development-plan.md` | `{folderMap.product}/{project}/YYYY-MM-DD-s4-development-plan.md` |
| `s4-wbs.md` | `{folderMap.product}/{project}/YYYY-MM-DD-s4-wbs.md` |
...
SIGIL S4 완료
    ↓
/trine 커맨드 실행 (SIGIL 워크스페이스)
    ↓
sigil-workspace.json 읽기 → 경로 해석
    ↓
...
5. Human에게 Trine 진입 안내를 제공하고 승인을 기다린다

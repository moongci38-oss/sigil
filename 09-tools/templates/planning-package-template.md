...
> S3 기획서에서 사용한 핵심 개념과 코드명 매핑 테이블.
> Trine Spec/코드 작성 시 이 테이블을 기준으로 한다. 동일 개념을 다른 이름으로 부르는 혼선 방지.

| 한국어 (기획/UX 용어) | 영어 (코드명) | 정의 | 상위 개념 |
|-------------------|------------|------|---------|
| {예시: 게시글} | {Post} | {사용자가 작성하는 콘텐츠 단위} | {Feed} |
| {예시: 팔로워} | {Follower} | {특정 사용자를 구독하는 사람} | {User} |
| (프로젝트별 추가) | | | |

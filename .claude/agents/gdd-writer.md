...
| 3.3 주요 화면 상세 | **필수**: 경쟁작 1개 | **필수**: 경쟁작 2+개 | `/game-screenshot-analyze` |
...
| 6.3 UI/UX 가이드 | 선택 | **필수**: 경쟁작 분석+목업 | `/game-screenshot-analyze` + Stitch MCP |
...
스크린샷 분석?
  └─ /game-screenshot-analyze (Gemini Vision)
영상 연출 분석?

...
tools: Read, Write, Edit, Task, mcp__brave-search__brave_web_search, mcp__brave-search__brave_news_search
model: opus
---
...
| **`mcp__brave-search__brave_web_search`** | Tool | 웹 검색 (WebSearch 대체/보완, 더 풍부한 메타데이터) |
| **`mcp__brave-search__brave_news_search`** | Tool | 뉴스 전용 검색 (최신성 필터, 날짜 범위 지원) |
...
- **시장/경쟁**: `mcp__brave-search__brave_web_search` + `/competitor` + `marketing:competitive-analysis`
- **뉴스/동향**: `mcp__brave-search__brave_news_search` (날짜 필터 활용)

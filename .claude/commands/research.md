...
argument-hint: <조사 주제>
allowed-tools: Read, Write, mcp__brave-search__brave_web_search, mcp__brave-search__brave_news_search, mcp__memory__search_nodes
---
...
1. **사전 확인**: mcp__memory__search_nodes로 이전에 같은 주제를 조사한 적 있는지 확인
2. **시장 조사**: Brave Search로 최신 정보 수집 (출처 URL, 날짜 반드시 포함)
